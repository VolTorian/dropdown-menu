...
const dropdown1 = new Dropdown("dropdown1", ["item 1", "only strings", "for now", "lol"], {width:"inherit", openType:"hover"});
const dropdown2 = new Dropdown("dropdown2", ["item 1", "only strings", "for now", "lol"], {stayOpenOnSelect:true, closeType:"toggle"});
